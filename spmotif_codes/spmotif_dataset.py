...
class SPMotif(InMemoryDataset):
    ...
    def processed_file_names(self):
        return ['SPMotif_train.pt', 'SPMotif_val.pt', 'SPMotif_test.pt','SPMotif_train_get_crane_tree.pt', 'SPMotif_train_get_crane_ladder.pt', 'SPMotif_train_get_crane_whell.pt', 'SPMotif_train_get_house_tree.pt', 'SPMotif_train_get_house_ladder.pt', 'SPMotif_train_get_house_whell.pt', 'SPMotif_train_get_cycle_tree.pt', 'SPMotif_train_get_cycle_ladder.pt', 'SPMotif_train_get_cycle_whell.pt', 'SPMotif_train_ban.pt']
